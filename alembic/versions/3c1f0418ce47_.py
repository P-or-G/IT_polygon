...
Revision ID: 3c1f0418ce47
Revises: 
Create Date: 2025-02-10 17:46:26.146934
...
def upgrade() -> None:
    ...
    sa.Column('test_text', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('litera', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('points', sa.Integer(), nullable=False),
    sa.Column('teacher', sa.Boolean(), nullable=False),
    sa.Column('com_lessons', sa.JSON(), nullable=True),
