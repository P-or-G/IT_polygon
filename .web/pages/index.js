...
export function Fragment_428e6520656a790261f9900eaaa2a311 () {
  ...
  const ref_my_content_area_el = useRef(null); refs["ref_my_content_area_el"] = ref_my_content_area_el;
                ...
                useEffect(() => {
                    ((...args) => (addEvents([(Event("reflex___state____state.reflex_local_auth___local_auth____local_auth_state.prdprf___auth___state____session_state.prdprf___articles___state____article_public_state.set_limit_and_reload", ({ ["new_limit"] : 20 }), ({  })))], args, ({  }))))()
                    return () => {
  ...
  const ref_my_child = useRef(null); refs["ref_my_child"] = ref_my_child;
                ...
                useEffect(() => {
                    ((...args) => (addEvents([(Event("reflex___state____state.reflex_local_auth___local_auth____local_auth_state.prdprf___auth___state____session_state.prdprf___articles___state____article_public_state.set_limit_and_reload", ({ ["new_limit"] : 1 }), ({  })))], args, ({  }))))()
                    return () => {
...
<>{reflex___state____state__reflex_local_auth___local_auth____local_auth_state__prdprf___auth___state____session_state__prdprf___articles___state____article_public_state.posts.map((post, index_be983c7490771830) => (
  <RadixThemesCard asChild={true} key={index_be983c7490771830}>
...
{"\u041e\u0431\u0440\u0430\u0437\u043e\u0432\u0430\u0442\u0435\u043b\u044c\u043d\u0430\u044f \u043f\u043b\u043e\u0449\u0430\u0434\u043a\u0430 IT-\u043f\u043e\u043b\u0438\u0433\u043e\u043d\u0430 \u0448\u043a\u043e\u043b\u044b 947"}
</RadixThemesHeading>
<RadixThemesLink asChild={true} css={({ ["&:hover"] : ({ ["color"] : "var(--accent-8)" }) })}>
...
export function Errorboundary_b9d0dd383fb90d0805d224d72d539f9d () {
...
<Fragment_428e6520656a790261f9900eaaa2a311/>
<NextHead>
...
export default function Component() {
  ...
  return (
    <Errorboundary_b9d0dd383fb90d0805d224d72d539f9d/>
  )
}
