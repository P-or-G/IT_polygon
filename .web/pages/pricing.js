...
export function Errorboundary_af04a094b0777406fa3cf00ef5ddde7c () {
...
<Fragment_1d09117c9c20d55e9ac0304d7cda1c4d/>
<NextHead>
...
export function Fragment_1d09117c9c20d55e9ac0304d7cda1c4d () {
...
{((resolvedColorMode === "light") ? "\u0412\u043a\u043b\u044e\u0447\u0438\u0442\u044c \u0442\u0451\u043c\u043d\u044b\u0439 \u0440\u0435\u0436\u0438\u043c" : "\u0412\u043a\u043b\u044e\u0447\u0438\u0442\u044c \u0441\u0432\u0435\u0442\u043b\u044b\u0439 \u0440\u0435\u0436\u0438\u043c")}
</RadixThemesText>
</RadixThemesFlex>
</RadixThemesBox>
...
<RadixThemesFlex css={({ ["@media screen and (min-width: 0)"] : ({ ["flexDirection"] : "column" }), ["@media screen and (min-width: 30em)"] : ({ ["flexDirection"] : "column" }), ["@media screen and (min-width: 48em)"] : ({ ["flexDirection"] : "row" }), ["width"] : "100%", ["alignItems"] : "center" })} gap={"4"}>

<RadixThemesFlex align={"start"} className={"rx-Stack"} css={({ ["border"] : "1.5px solid var(--gray-5)", ["background"] : "var(--gray-1)", ["padding"] : "28px", ["width"] : "100%", ["maxWidth"] : "400px", ["minHeight"] : "475px", ["borderRadius"] : "0.5rem" })} direction={"column"} gap={"6"}>

<RadixThemesFlex align={"start"} className={"rx-Stack"} css={({ ["height"] : "35px", ["alignItems"] : "center", ["width"] : "100%" })} direction={"row"} justify={"between"} gap={"3"}>

<RadixThemesFlex align={"start"} className={"rx-Stack"} css={({ ["width"] : "100%", ["alignItems"] : "end" })} direction={"row"} gap={"2"}>

<RadixThemesText as={"s"} css={({ ["opacity"] : 0.8 })} size={"3"} trim={"both"} weight={"regular"}>

{"$14.99"}
</RadixThemesText>
<RadixThemesText as={"p"} size={"6"} trim={"both"} weight={"regular"}>

{"$3.99"}
</RadixThemesText>
</RadixThemesFlex>
</RadixThemesFlex>
<RadixThemesText as={"p"} css={({ ["width"] : "100%", ["textAlign"] : "left" })} size={"7"} weight={"bold"}>
...
<LucideCheckIcon css={({ ["color"] : "var(--blue-9)" })} size={21}/>
...
<RadixThemesFlex css={({ ["flex"] : 1, ["justifySelf"] : "stretch", ["alignSelf"] : "stretch" })}/>
<RadixThemesButton color={"blue"} css={({ ["width"] : "100%" })} size={"3"} variant={"outline"}>

{"Purchase"}
</RadixThemesButton>
</RadixThemesFlex>
<RadixThemesFlex align={"start"} className={"rx-Stack"} css={({ ["border"] : "1.5px solid var(--blue-6)", ["background"] : "var(--blue-1)", ["padding"] : "28px", ["width"] : "100%", ["maxWidth"] : "400px", ["minHeight"] : "475px", ["borderRadius"] : "0.5rem" })} direction={"column"} gap={"6"}>

<RadixThemesFlex align={"start"} className={"rx-Stack"} css={({ ["alignItems"] : "center", ["height"] : "35px", ["width"] : "100%" })} direction={"row"} justify={"between"} gap={"3"}>
...
<RadixThemesBadge color={"blue"} radius={"full"} size={"2"} variant={"soft"}>
...
<RadixThemesFlex css={({ ["flex"] : 1, ["justifySelf"] : "stretch", ["alignSelf"] : "stretch" })}/>
<RadixThemesButton color={"blue"} css={({ ["width"] : "100%" })} size={"3"}>
...
export default function Component() {
  ...
  return (
    <Errorboundary_af04a094b0777406fa3cf00ef5ddde7c/>
  )
}
