...
export function Errorboundary_6070ac09f872ed2ce17b64b90bb5439e () {
...
<Fragment_31ecc47d8bdd88dd5bc6d87e17a8c709/>
<NextHead>
...
export function Fragment_31ecc47d8bdd88dd5bc6d87e17a8c709 () {
  ...
  const reflex___state____state__prdprf___auth___state____my_local_auth_state__prdprf___auth___state____session_state__prdprf___contact___state____contact_state = useContext(StateContexts.reflex___state____state__prdprf___auth___state____my_local_auth_state__prdprf___auth___state____session_state__prdprf___contact___state____contact_state)
  ...
  const ref_my_navbar_hstack_desktop = useRef(null); refs["ref_my_navbar_hstack_desktop"] = ref_my_navbar_hstack_desktop;
    ...
    const handleSubmit_872185ccfa54f4f4feec2ff6774592d5 = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({  })};

        (((...args) => (addEvents([(Event("reflex___state____state.prdprf___auth___state____my_local_auth_state.prdprf___auth___state____session_state.prdprf___contact___state____contact_state.handle_submit", ({ ["form_data"] : form_data }), ({  })))], args, ({  }))))());
...
{(reflex___state____state__prdprf___auth___state____my_local_auth_state__prdprf___auth___state____session_state__prdprf___contact___state____contact_state.did_submit ? "\u0421\u043f\u0430\u0441\u0438\u0431\u043e \u0437\u0430 \u0432\u0430\u0448\u0435 \u043e\u0431\u0440\u0430\u0449\u0435\u043d\u0438\u0435!" : "")}
<RadixThemesBox css={({ ["@media screen and (min-width: 0)"] : ({ ["display"] : "none" }), ["@media screen and (min-width: 30em)"] : ({ ["display"] : "none" }), ["@media screen and (min-width: 48em)"] : ({ ["display"] : "none" }), ["@media screen and (min-width: 62em)"] : ({ ["display"] : "block" }) })}>

<RadixThemesBox css={({ ["width"] : "50vw" })}>

<RadixFormRoot className={"Root "} css={({ ["width"] : "100%" })} onSubmit={handleSubmit_872185ccfa54f4f4feec2ff6774592d5}>
...
export default function Component() {
  ...
  return (
    <Errorboundary_6070ac09f872ed2ce17b64b90bb5439e/>
  )
}
