...
export function Errorboundary_4d82cf9865241899201103f031f116cf () {
...
<Fragment_d71e2a11ff4d29da2e651c6bf062f1bc/>
<NextHead>
...
export function Fragment_d71e2a11ff4d29da2e651c6bf062f1bc () {
  ...
  const reflex___state____state__reflex_local_auth___local_auth____local_auth_state__prdprf___auth___state____session_state__prdprf___contact___state____contact_state = useContext(StateContexts.reflex___state____state__reflex_local_auth___local_auth____local_auth_state__prdprf___auth___state____session_state__prdprf___contact___state____contact_state)
  ...
  const ref_my_navbar_hstack_desktop = useRef(null); refs["ref_my_navbar_hstack_desktop"] = ref_my_navbar_hstack_desktop;
    ...
    const handleSubmit_139fd68b964266997f600b7ef407f083 = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({  })};

        (((...args) => (addEvents([(Event("reflex___state____state.reflex_local_auth___local_auth____local_auth_state.prdprf___auth___state____session_state.prdprf___contact___state____contact_state.handle_submit", ({ ["form_data"] : form_data }), ({  })))], args, ({  }))))());
...
{(reflex___state____state__reflex_local_auth___local_auth____local_auth_state__prdprf___auth___state____session_state__prdprf___contact___state____contact_state.did_submit ? "\u0421\u043f\u0430\u0441\u0438\u0431\u043e \u0437\u0430 \u0432\u0430\u0448\u0435 \u043e\u0431\u0440\u0430\u0449\u0435\u043d\u0438\u0435!" : "")}
<RadixThemesBox css={({ ["@media screen and (min-width: 0)"] : ({ ["display"] : "none" }), ["@media screen and (min-width: 30em)"] : ({ ["display"] : "none" }), ["@media screen and (min-width: 48em)"] : ({ ["display"] : "none" }), ["@media screen and (min-width: 62em)"] : ({ ["display"] : "block" }) })}>

<RadixThemesBox css={({ ["width"] : "50vw" })}>

<RadixFormRoot className={"Root "} css={({ ["width"] : "100%" })} onSubmit={handleSubmit_139fd68b964266997f600b7ef407f083}>

<RadixThemesFlex align={"start"} className={"rx-Stack"} direction={"column"} gap={"3"}>

<RadixThemesTextField.Root css={({ ["width"] : "100%" })} name={"email"} placeholder={"\u0412\u0430\u0448\u0430 \u043f\u043e\u0447\u0442\u0430"} type={"email"}/>
<RadixThemesTextArea css={({ ["width"] : "100%" })} name={"message"} placeholder={"\u0412\u0430\u0448\u0430 \u043f\u0440\u043e\u0431\u043b\u0435\u043c\u0430"} required={true}/>
...
export default function Component() {
  ...
  return (
    <Errorboundary_4d82cf9865241899201103f031f116cf/>
  )
}
