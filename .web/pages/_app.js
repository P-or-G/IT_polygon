...
<RadixThemesTheme accentColor={"sky"} css={{...theme.styles.global[':root'], ...theme.styles.global.body}} hasBackground={true} panelBackground={"solid"} radius={"medium"} scaling={"90%"}>
