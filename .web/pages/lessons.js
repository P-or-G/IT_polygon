...
export function Errorboundary_4a1ea6b71f9bb92cd6d1a29e4a812ad1 () {
...
<Fragment_3dae126ed505ad234dc5c6635d3785e5/>
</Fragment>
<NextHead>
...
export function Fragment_3dae126ed505ad234dc5c6635d3785e5 () {
...
<>{reflex___state____state__prdprf___auth___state____my_local_auth_state__prdprf___auth___state____session_state__prdprf___lessons___state____blog_post_state.posts.map((post, index_4fc711e2941b136c) => (
  <RadixThemesBox css={({ ["padding"] : "1em" })} key={index_4fc711e2941b136c}>

<RadixThemesLink asChild={true} css={({ ["&:hover"] : ({ ["color"] : "var(--accent-8)" }) })}>

<NextLink href={("/lessons/"+post["id"])} passHref={true}>
...
export default function Component() {
  ...
  return (
    <Errorboundary_4a1ea6b71f9bb92cd6d1a29e4a812ad1/>
  )
}
