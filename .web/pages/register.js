...
export function Errorboundary_fa492db6127c808d48f075728a626bf6 () {
...
<Fragment_f435be4830de5b4e1b81eab12f00f875/>
<NextHead>
...
export function Fragment_f435be4830de5b4e1b81eab12f00f875 () {
  ...
  const ref_my_navbar_hstack_desktop = useRef(null); refs["ref_my_navbar_hstack_desktop"] = ref_my_navbar_hstack_desktop;
    ...
    const handleSubmit_eee866054caccc045c6760db6feef5f8 = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({ ["\u041f\u0430\u0440\u043e\u043b\u044c"] : getRefValue(refs["ref_\u041f\u0430\u0440\u043e\u043b\u044c"]), ["\u041f\u043e\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043d\u0438\u0435_\u043f\u0430\u0440\u043e\u043b\u044f"] : getRefValue(refs["ref_\u041f\u043e\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043d\u0438\u0435_\u043f\u0430\u0440\u043e\u043b\u044f"]), ["\u0410\u0434\u0440\u0435\u0441"] : getRefValue(refs["ref_\u0410\u0434\u0440\u0435\u0441"]), ["\u0424\u0430\u043c\u0438\u043b\u0438\u044f"] : getRefValue(refs["ref_\u0424\u0430\u043c\u0438\u043b\u0438\u044f"]), ["\u0418\u043c\u044f"] : getRefValue(refs["ref_\u0418\u043c\u044f"]) })};
...
<RadixFormRoot className={"Root "} css={({ ["width"] : "100%" })} onSubmit={handleSubmit_eee866054caccc045c6760db6feef5f8}>
...
export default function Component() {
  ...
  return (
    <Errorboundary_fa492db6127c808d48f075728a626bf6/>
  )
}
