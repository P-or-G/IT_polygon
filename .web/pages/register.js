...
export function Errorboundary_ad9e2c4bdd9d0b847ffc5d1d49c11821 () {
...
<Fragment_6c19ce9e22ce87b1ecda917ffb8a7cc6/>
<NextHead>
...
export function Fragment_6c19ce9e22ce87b1ecda917ffb8a7cc6 () {
  ...
  const ref_Адрес = useRef(null); refs["ref_\u0410\u0434\u0440\u0435\u0441"] = ref_Адрес;
  ...
  const ref_my_navbar_hstack_desktop = useRef(null); refs["ref_my_navbar_hstack_desktop"] = ref_my_navbar_hstack_desktop;
    ...
    const handleSubmit_f313c462dd665fb61b1dfc2ec4907f61 = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({ ["\u0418\u043c\u044f"] : getRefValue(refs["ref_\u0418\u043c\u044f"]), ["\u041f\u0430\u0440\u043e\u043b\u044c"] : getRefValue(refs["ref_\u041f\u0430\u0440\u043e\u043b\u044c"]), ["\u0424\u0430\u043c\u0438\u043b\u0438\u044f"] : getRefValue(refs["ref_\u0424\u0430\u043c\u0438\u043b\u0438\u044f"]), ["\u041f\u043e\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043d\u0438\u0435_\u043f\u0430\u0440\u043e\u043b\u044f"] : getRefValue(refs["ref_\u041f\u043e\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043d\u0438\u0435_\u043f\u0430\u0440\u043e\u043b\u044f"]), ["\u0410\u0434\u0440\u0435\u0441"] : getRefValue(refs["ref_\u0410\u0434\u0440\u0435\u0441"]) })};
...
<RadixFormRoot className={"Root "} css={({ ["width"] : "100%" })} onSubmit={handleSubmit_f313c462dd665fb61b1dfc2ec4907f61}>
...
<RadixThemesTextField.Root css={({ ["width"] : "100%" })} id={"\u0410\u0434\u0440\u0435\u0441"} name={"\u0410\u0434\u0440\u0435\u0441"} placeholder={"\u0410\u0434\u0440\u0435\u0441"} ref={ref_Адрес} type={"email"}/>
...
export default function Component() {
  ...
  return (
    <Errorboundary_ad9e2c4bdd9d0b847ffc5d1d49c11821/>
  )
}
