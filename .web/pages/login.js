...
import { Button as RadixThemesButton, Callout as RadixThemesCallout, Card as RadixThemesCard, Flex as RadixThemesFlex, Heading as RadixThemesHeading, Link as RadixThemesLink, TextField as RadixThemesTextField } from "@radix-ui/themes"
...
export function Errorboundary_214053b3f536d44f23704ca4b754dbe1 () {
...
<Fragment_68f979be0d3394a132677ea79936c730/>
</RadixThemesFlex>
</Fragment>
<NextHead>
...
export function Fragment_68f979be0d3394a132677ea79936c730 () {
  ...
  const ref_Пароль = useRef(null); refs["ref_\u041f\u0430\u0440\u043e\u043b\u044c"] = ref_Пароль;
    ...
    const handleSubmit_0a845ef575eea23c5471e6faec3fa7f1 = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({ ["\u041f\u0430\u0440\u043e\u043b\u044c"] : getRefValue(refs["ref_\u041f\u0430\u0440\u043e\u043b\u044c"]), ["\u041f\u043e\u0447\u0442\u0430"] : getRefValue(refs["ref_\u041f\u043e\u0447\u0442\u0430"]) })};

        (((...args) => (addEvents([(Event("reflex___state____state.reflex_local_auth___local_auth____local_auth_state.reflex_local_auth___login____login_state.prdprf___auth___state____my_login_state.on_submit", ({ ["form_data"] : form_data }), ({  })))], args, ({  }))))());
...
<RadixFormRoot className={"Root "} css={({ ["width"] : "100%" })} onSubmit={handleSubmit_0a845ef575eea23c5471e6faec3fa7f1}>
...
{isTrue(!((reflex___state____state__reflex_local_auth___local_auth____local_auth_state__reflex_local_auth___login____login_state.error_message === ""))) ? (
  <Fragment>
...
{reflex___state____state__reflex_local_auth___local_auth____local_auth_state__reflex_local_auth___login____login_state.error_message}
</RadixThemesCallout.Text>
...
<RadixThemesTextField.Root css={({ ["width"] : "100%" })} id={"\u041f\u043e\u0447\u0442\u0430"} name={"\u041f\u043e\u0447\u0442\u0430"} placeholder={"\u041f\u043e\u0447\u0442\u0430"} ref={ref_Почта} type={"example@choch.com"}/>
<RadixThemesTextField.Root css={({ ["width"] : "100%" })} id={"\u041f\u0430\u0440\u043e\u043b\u044c"} name={"\u041f\u0430\u0440\u043e\u043b\u044c"} placeholder={"\u041f\u0430\u0440\u043e\u043b\u044c"} ref={ref_Пароль} type={"12345678"}/>
...
<RadixThemesLink css={({ ["&:hover"] : ({ ["color"] : "var(--accent-8)" }) })} href={"#"} onClick={((...args) => (addEvents([(Event("_redirect", ({ ["path"] : "/register", ["external"] : false, ["replace"] : false }), ({  })))], args, ({  }))))}>
...
<GoogleLogin onSuccess={((_data) => (addEvents([(Event("reflex___state____state.reflex_local_auth___local_auth____local_auth_state.reflex_local_auth___login____login_state.prdprf___auth___state____my_login_state.handle_google_login", ({ ["token_id"] : _data }), ({  })))], [_data], ({  }))))}/>
</RadixThemesFlex>
</RadixThemesFlex>
</RadixFormRoot>
</GoogleOAuthProvider>
...
export default function Component() {
  ...
  return (
    <Errorboundary_214053b3f536d44f23704ca4b754dbe1/>
  )
}
