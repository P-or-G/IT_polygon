...
export function Fragment_d571e51e0312df78b95e89c2f094dcd3 () {
  ...
  const ref_my_navbar_hstack_desktop = useRef(null); refs["ref_my_navbar_hstack_desktop"] = ref_my_navbar_hstack_desktop;
    ...
    const handleSubmit_83f4b9023c5aa0aaaf89e8823ad503f6 = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({  })};

        (((...args) => (addEvents([(Event("reflex___state____state.reflex_local_auth___local_auth____local_auth_state.prdprf___auth___state____session_state.prdprf___lessons___state____blog_post_state.prdprf___lessons___state____blog_edit_form_state.handle_submit", ({ ["form_data"] : form_data }), ({  })))], args, ({  }))))());
...
{isTrue(reflex___state____state__reflex_local_auth___local_auth____local_auth_state__prdprf___auth___state____session_state__prdprf___lessons___state____blog_post_state.post) ? (
  <Fragment>
...
{"\u0420\u0435\u0434\u0430\u043a\u0442\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u0435 "}
{reflex___state____state__reflex_local_auth___local_auth____local_auth_state__prdprf___auth___state____session_state__prdprf___lessons___state____blog_post_state.post?.["title"]}
</RadixThemesHeading>
<RadixThemesBox css={({ ["@media screen and (min-width: 0)"] : ({ ["display"] : "none" }), ["@media screen and (min-width: 30em)"] : ({ ["display"] : "none" }), ["@media screen and (min-width: 48em)"] : ({ ["display"] : "none" }), ["@media screen and (min-width: 62em)"] : ({ ["display"] : "block" }) })}>

<RadixThemesBox css={({ ["width"] : "50vw" })}>

<RadixFormRoot className={"Root "} css={({ ["width"] : "100%" })} onSubmit={handleSubmit_83f4b9023c5aa0aaaf89e8823ad503f6}>
...
<RadixThemesTextField.Root css={({ ["width"] : "100%" })} defaultValue={reflex___state____state__reflex_local_auth___local_auth____local_auth_state__prdprf___auth___state____session_state__prdprf___lessons___state____blog_post_state.post?.["title"]} name={"title"} placeholder={"\u041d\u0430\u0437\u0432\u0430\u043d\u0438\u0435"} required={true} type={"text"}/>
</RadixThemesFlex>
<DebounceInput css={({ ["height"] : "50vh", ["width"] : "100%" })} debounceTimeout={300} element={RadixThemesTextArea} name={"content"} onChange={((_e) => (addEvents([(Event("reflex___state____state.reflex_local_auth___local_auth____local_auth_state.prdprf___auth___state____session_state.prdprf___lessons___state____blog_post_state.set_post_content", ({ ["value"] : _e["target"]["value"] }), ({  })))], [_e], ({  }))))} placeholder={"\u0412\u0430\u0448\u0435 \u0441\u043e\u043e\u0431\u0449\u0435\u043d\u0438\u0435"} required={true} value={reflex___state____state__reflex_local_auth___local_auth____local_auth_state__prdprf___auth___state____session_state__prdprf___lessons___state____blog_post_state.post_content}/>
<RadixThemesFlex gap={"2"}>

<RadixThemesSwitch defaultChecked={reflex___state____state__reflex_local_auth___local_auth____local_auth_state__prdprf___auth___state____session_state__prdprf___lessons___state____blog_post_state.post_publish_active} name={"publish_active"} onCheckedChange={((_ev_0) => (addEvents([(Event("reflex___state____state.reflex_local_auth___local_auth____local_auth_state.prdprf___auth___state____session_state.prdprf___lessons___state____blog_post_state.set_post_publish_active", ({ ["value"] : _ev_0 }), ({  })))], [_ev_0], ({  }))))}/>
...
{isTrue(reflex___state____state__reflex_local_auth___local_auth____local_auth_state__prdprf___auth___state____session_state__prdprf___lessons___state____blog_post_state.post_publish_active) ? (
  <Fragment>
...
export function Errorboundary_b3c0bb1dca33096de5f30abf2744c7a5 () {
...
<Fragment_d571e51e0312df78b95e89c2f094dcd3/>
</Fragment>
<NextHead>
...
export default function Component() {
  ...
  return (
    <Errorboundary_b3c0bb1dca33096de5f30abf2744c7a5/>
  )
}
